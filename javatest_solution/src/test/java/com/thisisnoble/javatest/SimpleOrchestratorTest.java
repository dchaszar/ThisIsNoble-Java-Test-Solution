...
import com.thisisnoble.javatest.impl.TestOrchestrator; //My Orchestrator Implementation
...
public class SimpleOrchestratorTest {
    ...
    private Orchestrator createOrchestrator() {
    	...
    	//My Implementation of Orchestrator
    	Orchestrator myTestOrchestrator = new TestOrchestrator();
    	
    	return myTestOrchestrator;
